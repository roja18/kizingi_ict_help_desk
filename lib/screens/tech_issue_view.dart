...
class TechListIssuesPage extends StatefulWidget {
  const TechListIssuesPage({super.key});

  @override
  State<TechListIssuesPage> createState() => _TechListIssuesPageState();
}

class _TechListIssuesPageState extends State<TechListIssuesPage> {
