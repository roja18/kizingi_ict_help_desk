...
class TechChartBot extends StatefulWidget {
  const TechChartBot({super.key});

  @override
  State<TechChartBot> createState() => _TechChartBotState();
}

class _TechChartBotState extends State<TechChartBot> {
